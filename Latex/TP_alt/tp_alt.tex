...
\section*{{\fontfamily{qcr}\selectfont TAD \textdollar BerretaCoin} \{}
    ...
    \indent{\fontfamily{qcr}\selectfont\textbf{pred sonTransaccionesValidas} (S: bloque, B: blockchain)} \{\\
    ...
    \indent{\fontfamily{qcr}\selectfont\textbf{pred esUsuarioDeBloque} (S: bloque, id: \Entero)} \{\\
        \indent\indent $(\exists i$:\Entero)$(\exists j$:\Entero) ($0 \le i < |s|)$ $\land_{L}$ ($0 \le j < |s_{[i]}.transacciones|)$ $\land_{L}$ (id = $S_{[i]}.transacciones_{[j]}.idVendedor$)
